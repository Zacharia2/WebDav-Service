...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        path = new Path();
        path.moveTo((float) getWidth() / 2, getHeight() - footerLineHeight - footerTriangleHeight);
        path.lineTo((float) getWidth() / 2 + footerTriangleHeight, getHeight() - footerLineHeight);
        path.lineTo((float) getWidth() / 2 - footerTriangleHeight, getHeight() - footerLineHeight);
        path.close();
